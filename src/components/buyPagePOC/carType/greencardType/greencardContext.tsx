...
const greencardContext = createContext<{
...
const GreencardContextProvider = ({ children }: { children: JSX.Element }) => {
  ...
  const getPremium = async () => {
    const body = {
      data: formData,
      productSiteId: PRODUCT_INFO.GREENCARD.productSiteId,
    };
  ...
  // provider logic here
  return (
    <greencardContext.Provider value={{ formData: formData, setFormData: setFormData }}>
...
export { greencardContext, GreencardContextProvider };
