...
const privateSilverContext = createContext<{
...
const PrivateSilverContextProvider = ({
  children,
}: {
...
export { privateSilverContext, PrivateSilverContextProvider };
