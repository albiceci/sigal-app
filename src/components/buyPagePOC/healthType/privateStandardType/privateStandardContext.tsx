...
import { formFields as firstFormFields } from "../privateGoldType/firstForm/firstFormTypes";
import { formFields as secondFormFields } from "../privateGoldType/secondForm/secondFormTypes";
...
const privateStandardContext = createContext<{
...
const PrivateStandardContextProvider = ({
  children,
}: {
  ...
  // provider logic here
  return (
    <privateStandardContext.Provider
...
export { privateStandardContext, PrivateStandardContextProvider };
