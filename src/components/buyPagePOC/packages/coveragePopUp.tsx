...
export const CoveragesPopUp = ({ packageData, onClose }: { packageData: packageType; onClose: () => void }) => {
  return (
    <Overlay>
      <div className="w-[95vw] sm:w-[80vw] md:w-[70vw] lg:w-[50vw] flex flex-col rounded-md bg-white shadow-lg max-h-[80dvh]">
        ...
        <div className="px-6 overflow-y-auto pb-3 flex flex-col gap-2">
