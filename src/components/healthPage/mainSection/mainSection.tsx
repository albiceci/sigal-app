...
function MainSection() {
  ...
  return (
    <article className="w-[100vw] min-h-[750px] relative overflowx-hidden m-0 sm:min-h-[max(100vh,800px)] flex justify-center">
      <div className="h-fit w-full flex items-center justify-center bottom-0 absolute">
        <img src={heroImage} className="min-w-[1100px] sm:min-w-[1300px] lg:w-[100%] h-auto" alt="heroImage" />
      </div>
      <div className="absolute mt-[150px] flex flex-col gap-6 items-center z-10 max-w-[350px] md:max-w-[500px] lg:max-w-[600px]">
        <div className="flex flex-col gap-4 items-center justify-center">
          <h1 className="h2 text-primary text-center">Shëndeti vjen i pari</h1>
          <p className="text-center text-[15px] sm:text-[18px] font-medium font-subheader text-presetblack max-w-[300px] md:max-w-[450px] lg:max-w-[550px]">
            Paketa sigurimi privat shëndeti për çdo moshë dhe buxhet
          </p>
        </div>
        <div className="w-fit">
          <Button
      ...
      <div
        className={`z-10 flex w-full items-center justify-center bottom-14 lg:bottom-8 ${
