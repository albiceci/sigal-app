...
function MainSection() {
  ...
  return (
    <article className="w-[100vw] min-h-[800px] relative overflowx-hidden m-0 sm:min-h-[max(100vh,800px)] xl:min-h-[max(110vh,800px)] 2xl:min-h-[max(115vh,800px)] flex justify-center">
      ...
      <div className="absolute mt-[150px] flex flex-col gap-6 items-center z-10 max-w-[350px] md:max-w-[500px] lg:max-w-[600px]">
        <div className="flex flex-col gap-4 items-center justify-center">
          <h1 className="h2 text-primary text-center">Sigurimi i Prones</h1>
          <p className="text-center text-[15px] sm:text-[18px] font-medium font-subheader text-presetblack max-w-[300px] md:max-w-[450px] lg:max-w-[550px]">
            Siguroni shtëpinë, apartamentin, biznesin nga zjarri dhe katastrofat natyrore
          </p>
        </div>
        <div className="w-fit">
          <Button
            ...
            onClick={() => {
              navigate("/buy?type=form&subtype=property");
            }}
          >
            SIGUROHU
          </Button>
